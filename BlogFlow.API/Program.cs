...
//for Non-db, only frontend request
if (app.Environment.IsProduction())
{
    app.MapGet("/api/posts", () =>
    {
        var mockPosts = new[]
        {
            new { Id = 1, Title = "Mock Post 1", Content = "This is the first mock post." },
            new { Id = 2, Title = "Mock Post 2", Content = "Another post to simulate data." }
        };

        return Results.Ok(mockPosts);
    });
}
else
{
